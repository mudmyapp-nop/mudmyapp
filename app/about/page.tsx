...
const faqs = [
  {
    ...
    answer: 'Mudmy หรือหมุดหมาย คือแพลตฟอร์มชุมชนไทยบนแผนที่สำหรับค้นหาสินค้า ร้านค้า งาน บริการ ข่าวสาร และความช่วยเหลือใกล้บ้าน',
  },
  {
...
export const metadata: Metadata = {
  title: 'เกี่ยวกับเรา | ชุมชนไทยบนแผนที่',
  description: 'ทำความรู้จัก Mudmy แพลตฟอร์มชุมชนไทยบนแผนที่ที่ช่วยเชื่อมโยงสินค้า บริการ งาน ข่าวสาร และความช่วยเหลือใกล้บ้าน โดยไม่เก็บค่าคอมมิชชั่น',
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-muted-foreground sm:text-lg">
                หมุดหมาย หรือ Mudmy เกิดจากความตั้งใจที่จะสร้างพื้นที่ออนไลน์ที่อบอุ่นและใช้งานได้จริงสำหรับคนไทย พื้นที่ที่คนตัวเล็ก ๆ ร้านค้าในชุมชน ผู้ให้บริการ และคนที่กำลังมองหาโอกาส สามารถพบกันได้อย่างเป็นธรรมชาติ
              </p>
            </div>
